...
public class ThreeBallWAssist extends SequentialCommandGroup
{
  /**
  ...
  public ThreeBallWAssist(FlyWheelSubsystem flyWheelSubsys, DriveSubsystem driveSubsys, GateSubsystem gateSubsys, SPathSubsystem SPathSubsys,
