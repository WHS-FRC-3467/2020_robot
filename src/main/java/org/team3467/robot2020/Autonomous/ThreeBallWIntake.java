...
import org.team3467.robot2020.subsystems.DriveSubsystem.PivotTime;
...
public class ThreeBallWIntake extends SequentialCommandGroup
{
  /**
  ...
  public ThreeBallWIntake(FlyWheelSubsystem flyWheelSubsys, DriveSubsystem driveSubsys, GateSubsystem gateSubsys, SPathSubsystem SPathSubsys,
      CD7Subsystem CD7Subsys, IntakeSubsystem IntakeSubsys)
  {
    ...
    addCommands(
      ...
      new PivotTime(m_drive, 0.5, 0.25, false),
      new driveTime(m_drive, 4.0, 0.25),
      new PivotTime(m_drive, 0.5, 0.25, true ),
      new deployIntake(m_intake),
      new IntakeDrive(m_intake, m_drive)
    );
  }
}
