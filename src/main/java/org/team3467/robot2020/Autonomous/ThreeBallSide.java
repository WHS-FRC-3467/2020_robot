...
public class ThreeBallSide extends SequentialCommandGroup
{
  /**
  ...
  public ThreeBallSide(FlyWheelSubsystem flyWheelSubsys, DriveSubsystem driveSubsys, GateSubsystem gateSubsys, SPathSubsystem SPathSubsys,
